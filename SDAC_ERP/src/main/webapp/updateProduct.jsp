...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="profile-section">
            ...
            <p>SellerID: <%= session.getAttribute("port_id") %></p>
        </div>
        <nav class="nav flex-column">
            <a class="btn btn-primary" href="addProduct.jsp" style="margin-bottom: 10px;">Add Product</a>
            
            <a class="btn btn-primary" href="updateOrderStatus.jsp" style="margin-bottom: 10px;">View Orders</a>
        ...
        <div class="card-body">
            <form action="ProductsController" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" id="price" name="price" class="form-control" placeholder="Enter Price">
                </div>
