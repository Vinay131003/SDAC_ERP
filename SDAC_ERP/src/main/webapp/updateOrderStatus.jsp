    ...
    <div class="container" style="max-width: 600px; margin: 0 auto;">
        <div class="card shadow-sm">
            <div class="card-header">
                <h2 class="text-center mt-2">Update Order Status</h2>
            </div>
            <div class="card-body">
                <form action="OrdersController" method="post" class="p-4">
                    <input type="hidden" name="action" value="updateStatus">
                    <div class="mb-3">
                        <label for="orderId" class="form-label">Order ID</label>
                        <input type="number" class="form-control" name="orderID" value="<%= orderID != null ? orderID : "" %>" required>
                    </div>
                    <div class="mb-3">
