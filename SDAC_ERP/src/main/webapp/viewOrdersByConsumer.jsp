...
<%@ page import="Order_Dao.ViewOrdersByConsumerDao"%>
...
// Fetch orders for the consumer using the DAO
ViewOrdersByConsumerDao ordersDao = new ViewOrdersByConsumerDao();
List<Orders> ordersList = ordersDao.getOrdersByConsumer(portID);
%>
